...
export default function Home(){
  ...
  return <div className="shell">
    ...
    <aside className={menu?"side show":"side"}>
      ...
      <div className="brand"><i>Dİ</i><div><b>Daxili İdarəetmə</b><small>İş və tapşırıq sistemi</small><small className="brandversion">Versiya 1.54</small></div></div>
...
function ChecklistSection({employeeView,checklist,loading,title,setTitle,busy,error,onAdd,onToggle,onRemove,canDelegate=false,delegateEmployees=[],onDelegate,onAttach,onDetach,attachBusyId=null}:{employeeView:boolean;checklist:ChecklistLikeItem[];loading:boolean;title:string;setTitle:(v:string)=>void;busy:boolean;error:string;onAdd:()=>void;onToggle:(item:ChecklistLikeItem)=>void;onRemove:(item:ChecklistLikeItem)=>void;canDelegate?:boolean;delegateEmployees?:Employee[];onDelegate?:(item:ChecklistLikeItem,employeeId:string)=>void;onAttach?:(item:ChecklistLikeItem,file:File)=>void;onDetach?:(item:ChecklistLikeItem)=>void;attachBusyId?:number|null}){
