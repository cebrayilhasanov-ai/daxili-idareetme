...
export default function Home(){
  ...
  const firstDocumentTab=(["templates","outgoing","incoming"] as const).find(tab=>can(`documents.${tab}`));
...
const SECTION_TREE:{key:string;label:string;children:SectionNode[]}[]=[
  ...
  {key:"documents",label:"Sənədlər",children:[{key:"documents.templates",label:"Şablonlar"},{key:"documents.outgoing",label:"Çıxan Sənədlər"},{key:"documents.incoming",label:"Daxil Olan Sənədlər"}]},
